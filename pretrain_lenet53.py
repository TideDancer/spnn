...
# Model
net = torch.load('pretrain/lenet53_v2.pk')
# net = Model.LENET53(img_size,10)
net = net.to(device)
print(net)
...
for epoch in range(151):
    ...
    train(epoch)
    test(epoch)
    if epoch % 30 == 0 and epoch > 0: torch.save(net, 'pretrain/lenet53_v2.pk')
# torch.save(net, 'pretrain/lenet53.pk')
